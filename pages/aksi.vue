<template>
  <div class="p-2">
      <div class="group relative flex h-72 sm:h-[400px] items-center px-12 overflow-hidden rounded-lg bg-gray-100 bg-gradient-to-tr from-blue-400 to-blue-600 ">
        <img src="https://images.unsplash.com/photo-1618556450991-2f1af64e8191?auto=format&q=75&fit=crop&w=1000" loading="lazy" class="absolute inset-0 h-full w-full object-cover object-center opacity-25 transition duration-200">
        <div class="relative text-white">
          <ol class="flex h-8 space-x-2">
            ...
            <li class="flex items-center space-x-2">
              /
              <a rel="noopener noreferrer" href="#" class="flex items-center px-1 capitalize hover:underline ml-2">Profile</a>
            </li>
            <li class="flex items-center space-x-2">
              /
            </li>
          </ol>
          <h3 class="text-black-800 text-2xl font-bold sm:text-3xl md:text-4xl">
            Tata Kelola Perusahaan
          </h3>
        </div>
      </div>
    </div>
<breadcumb activePageName="About Us" title="We are an agency located in New York" backgroundUrl= "/images/bg/breadcrumb-bg.jpg" />
  <!-- hero - start -->
    ...
    <div class="container bg-blue-100 mx-auto">
      ...
      <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="text-center">
          ...
          <h3 class="font-bold mb-4 text-lg dark:text-white">
            3. Add Your NFTs
          </h3>
          <p class="dark:text-jacarta-300">
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8">
        ...
        <p class="text-center text-xs text-gray-400">
          By signing up to our newsletter you agree to our <a href="#" class="underline transition duration-100 hover:text-indigo-500 active:text-indigo-600">Term of Service</a> and <a href="#" class="underline transition duration-100 hover:text-indigo-500 active:text-indigo-600">Privacy Policy</a>.
        </p>
      </div>
    </div>
  </div>
...
useHead({
  title: 'aksii',
  titleTemplate: '%s - Clipan Finance Indonesia',
  meta: [
    { name: 'description', content: 'Clipan Finance Indonesia' }
  ]
})
</script>